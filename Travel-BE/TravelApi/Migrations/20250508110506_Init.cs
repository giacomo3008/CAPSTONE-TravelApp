        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cities_ExperienceTypes_ExperienceTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListingDescriptions_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ListingDescriptions_PropertyTypes_PropertyTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "ListingDescriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserListingsFavorites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserListingsFavorites_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cities_ExperienceTypeId",
                table: "Cities",
                column: "ExperienceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ListingDescriptions_CityId",
                table: "ListingDescriptions",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_ListingDescriptions_PropertyTypeId",
                table: "ListingDescriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserListingsFavorites_ListingId",
                table: "UserListingsFavorites",
                column: "ListingId");

            migrationBuilder.CreateIndex(
                name: "IX_UserListingsFavorites_UserId",
                table: "UserListingsFavorites",
                column: "UserId");
        }
